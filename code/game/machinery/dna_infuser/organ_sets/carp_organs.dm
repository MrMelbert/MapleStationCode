...
/obj/item/organ/lungs/carp/pre_breath_gas_handling(mob/living/carbon/human/breather, datum/gas_mixture/breath)
...
/obj/item/organ/tongue/carp/on_bodypart_insert(obj/item/bodypart/limb)
	. = ..()
