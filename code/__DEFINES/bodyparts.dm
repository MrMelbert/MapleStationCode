...
#define LIMB_MAX_HP_PROSTHESIS 75 // 20 //Used by surplus prosthesis limbs.
#define LIMB_MAX_HP_DEFAULT 150 // 50 //Used by most all limbs by default.
#define LIMB_MAX_HP_ADVANCED 200 // 75 //Used by advanced robotic limbs.
#define LIMB_MAX_HP_CORE 600 // 200 //Only use this for heads and torsos.
