...
// // Overlay priorities
#define BODYPART_OVERLAY_SPACESUIT_MESH 1
#define BODYPART_OVERLAY_FISH_INFUSION 2
#define BODYPART_OVERLAY_CARP_INFUSION 3
#define BODYPART_OVERLAY_CSS_SUICIDE 4
#define BODYPART_OVERLAY_VOIDWALKER_CURSE 5
