...
#define SLIME_TYPE_DARK_BLUE "dark-blue" // NON-MODULE CHANGE
#define SLIME_TYPE_DARK_PURPLE "dark-purple" // NON-MODULE CHANGE
#define SLIME_TYPE_GOLD "gold"
#define SLIME_TYPE_GREEN "green"
#define SLIME_TYPE_GREY "grey"
#define SLIME_TYPE_LIGHT_PINK "light-pink" // NON-MODULE CHANGE
