...
#define DNA_FEATURE_BLOCKS 18 // NON-MODULE CHANGE
...
#define DNA_IPC_SCREEN_BLOCK 17 // NON-MODULE CHANGE //something something DNA soul
#define DNA_REPLOID_ANTENNA_BLOCK 18 // NON-MODULE CHANGE //seriously if you want to be hailed as a god, refactor TG's dna code
...
#define ORGAN_SLOT_EXTERNAL_REPLOID_ANTENNA "reploid_antenna" // NON-MODULE CHANGE
