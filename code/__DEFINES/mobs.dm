...
//MINOR TWEAKS/MISC
#define AGE_MIN 18 //youngest a character can be // NON-MODULE CHANGE
#define AGE_MAX 300 //oldest a character can be // NON-MODULE CHANGE
...
#define CAN_SUCCUMB(target) (HAS_TRAIT(target, TRAIT_CRITICAL_CONDITION) && !HAS_TRAIT(target, TRAIT_NODEATH) && target.health <= -100)
