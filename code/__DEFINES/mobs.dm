...
#define DEFAULT_BODYPART_ICON_ORGANIC 'icons/mob/species/human/bodyparts_greyscale.dmi' // MELBERT TODO - FUTURE EDIT: This define was dehardcoded, should be re-evaluated at some point.
