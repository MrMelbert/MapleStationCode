...
// Maplestation Todo : grabbing these defines but not their broader implementation, should do that eventually! Good luck at it, if you're running into the conflict this addition caused!
