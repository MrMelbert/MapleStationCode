...
/datum/controller/subsystem/mapping/proc/setup_ruins()
	...
	var/list/ice_ruins = levels_by_trait(ZTRAIT_SAND_RUINS)
	if (ice_ruins.len)
		// needs to be whitelisted for underground too so place_below ruins work
		seedRuins(ice_ruins, CONFIG_GET(number/icemoon_budget), list(/area/icemoon/surface/outdoors/unexplored, /area/icemoon/underground/unexplored), themed_ruins[ZTRAIT_SAND_RUINS], clear_below = TRUE)

	var/list/ice_ruins_underground = levels_by_trait(ZTRAIT_SAND_RUINS_UNDERGROUND)
	if (ice_ruins_underground.len)
		seedRuins(ice_ruins_underground, CONFIG_GET(number/icemoon_budget), list(/area/icemoon/underground/unexplored), themed_ruins[ZTRAIT_SAND_RUINS_UNDERGROUND], clear_below = TRUE)
