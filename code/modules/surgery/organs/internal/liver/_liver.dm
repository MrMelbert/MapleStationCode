	...
	if(!CAN_FEEL_PAIN(owner))
		switch(failure_time/LIVER_FAILURE_STAGE_SECONDS)
			...
			if(5)
				...
				owner.sharp_pain(BODY_ZONE_CHEST, 80, BRUTE, 30 SECONDS, 0.66)
