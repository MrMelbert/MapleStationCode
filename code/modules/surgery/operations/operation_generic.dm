...
/datum/surgery_operation/limb/fix_bones
	...
	preop_sound = list(
		...
		/obj/item/stack/medical/wrap/sticky_tape/surgical = 'sound/items/duct_tape_rip.ogg',
		/obj/item/stack/medical/wrap/sticky_tape/super = 'sound/items/duct_tape_rip.ogg',
		/obj/item/stack/medical/wrap/sticky_tape = 'sound/items/duct_tape_rip.ogg',
	)
	time = 4 SECONDS
	all_surgery_states_required = SURGERY_SKIN_OPEN
