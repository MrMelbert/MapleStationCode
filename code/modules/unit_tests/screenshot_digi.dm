...
/datum/unit_test/screenshot_digi/Run()
	...
	TEST_ASSERT((dummy.bodytype & BODYSHAPE_DIGITIGRADE), "Dummy (Ashwalker) should be digitigrade!")
	...
	TEST_ASSERT(!(dummy.bodytype & BODYSHAPE_DIGITIGRADE), "Dummy (Human) should be not digitigrade!")
	finished_icon = icon(finished_icon)
	...
	dummy.set_species(/datum/species/lizard/ashwalker)
	TEST_ASSERT((dummy.bodytype & BODYSHAPE_DIGITIGRADE), "Dummy (Ashwalker) should be digitigrade again!")
	finished_icon = icon(finished_icon)
