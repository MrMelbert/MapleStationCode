...
/datum/unit_test/eyestab/Run()
	...
	var/obj/item/organ/eyes/eyes = victim.get_organ_slot(ORGAN_SLOT_EYES) // Non-module change : this unit test was added after organs got simplified away from being internal/external
