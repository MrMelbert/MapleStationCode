...
/datum/unit_test/damp_rag_smother/Run()
	...
	var/obj/item/organ/internal/stomach/victim_stomach = victim.get_organ_slot(ORGAN_SLOT_STOMACH) // Non-module change : this unit test was added after organs got simplified away from being internal/external
