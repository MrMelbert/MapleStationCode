/obj/item/assembly/health
	...
	var/scanning = FALSE
	var/health_scan
	var/health_target = HEALTH_THRESHOLD_LIKELY_CRIT
...
/obj/item/assembly/health/proc/toggle_target()
	if(health_target == HEALTH_THRESHOLD_LIKELY_CRIT) // Non-module change
		health_target = HEALTH_THRESHOLD_LIKELY_DEAD // Non-module change
	else
		health_target = HEALTH_THRESHOLD_LIKELY_CRIT // Non-module change
	return
