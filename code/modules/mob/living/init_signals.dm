...
/mob/living/proc/on_knockedout_trait(datum/source)
	...
	if(HAS_TRAIT(src, TRAIT_KNOCKEDOUT))
		...
		add_traits(list(TRAIT_HANDS_BLOCKED, TRAIT_BLOCK_SECHUD, TRAIT_BLOCK_MEDHUD, TRAIT_IMMOBILIZED, TRAIT_INCAPACITATED, TRAIT_FLOORED, TRAIT_HEART_RATE_SLOW, TRAIT_CLOSED_EYES), TRAIT_KNOCKEDOUT)
		...
		remove_traits(list(TRAIT_HANDS_BLOCKED, TRAIT_BLOCK_SECHUD, TRAIT_BLOCK_MEDHUD, TRAIT_IMMOBILIZED, TRAIT_INCAPACITATED, TRAIT_FLOORED, TRAIT_HEART_RATE_SLOW, TRAIT_CLOSED_EYES), TRAIT_KNOCKEDOUT)
		update_body() // Update eyelids
		for(var/datum/atom_hud/alternate_appearance/basic/unconscious_obscurity/uncon_aa in GLOB.active_alternate_appearances)
