...
/mob/living/carbon/human/update_worn_undersuit()
	...
	if(istype(w_uniform, /obj/item/clothing/under))
		...
		if(hidden_slots_to_inventory_slots(obscured_slots) & ITEM_SLOT_ICLOTHING)
			return
...
/mob/living/carbon/human/update_worn_gloves()
	...
	if(hidden_slots_to_inventory_slots(obscured_slots) & ITEM_SLOT_GLOVES)
		return
...
/mob/living/carbon/human/update_worn_ears()
	...
	if(ears)
		...
		if(hidden_slots_to_inventory_slots(obscured_slots) & ITEM_SLOT_EARS)
			return
...
/mob/living/carbon/human/update_worn_shoes()
	...
	if(shoes)
		...
		if(hidden_slots_to_inventory_slots(obscured_slots) & ITEM_SLOT_FEET)
			return
...
/mob/living/carbon/human/update_suit_storage()
	...
	if(s_store)
		...
		if(hidden_slots_to_inventory_slots(obscured_slots) & ITEM_SLOT_SUITSTORE)
			return
...
/mob/living/carbon/human/update_worn_belt()
	...
	if(belt)
		...
		if(hidden_slots_to_inventory_slots(obscured_slots) & ITEM_SLOT_BELT)
			return
