...
/datum/tlv/temperature
	warning_min = BODYTEMP_COLD_DAMAGE_LIMIT + 10 CELCIUS
	hazard_min = BODYTEMP_COLD_DAMAGE_LIMIT
	warning_max = BODYTEMP_HEAT_DAMAGE_LIMIT - 10 CELCIUS
	hazard_max = BODYTEMP_HEAT_DAMAGE_LIMIT
