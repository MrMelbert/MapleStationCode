...
/datum/antagonist/nukeop/apply_innate_effects(mob/living/mob_override)
	...
	owner.mind.set_level(/datum/skill/electronics, SKILL_LEVEL_MASTER, silent = TRUE)
	owner.mind.set_level(/datum/skill/eva, SKILL_LEVEL_MASTER, silent = TRUE)
	owner.mind.set_level(/datum/skill/firearms, SKILL_LEVEL_MASTER, silent = TRUE)
	owner.mind.set_level(/datum/skill/first_aid, SKILL_LEVEL_MASTER, silent = TRUE)
	owner.mind.set_level(/datum/skill/athletics, SKILL_LEVEL_EXPERT, silent = TRUE)
	owner.mind.set_level(/datum/skill/mechanics, SKILL_LEVEL_MASTER, silent = TRUE)
	owner.mind.set_level(/datum/skill/surgery, SKILL_LEVEL_MASTER, silent = TRUE)
	owner.mind.set_level(/datum/skill/piloting, SKILL_LEVEL_EXPERT, silent = TRUE)
