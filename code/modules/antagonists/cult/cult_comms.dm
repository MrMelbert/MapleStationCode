...
/proc/pollCultists(mob/living/Nominee, datum/team/cult/team) //Cult Master Poll
	...
	var/list/yes_voters = SSpolling.poll_candidates("[Nominee] seeks to lead your cult, do you support [Nominee.p_them()]?", poll_time = 30 SECONDS, group = asked_cultists, alert_pic = Nominee, role_name_text = "cult master")
