...
/datum/micro_organism/cell_line/bear //bears can't really compete directly with more powerful creatures, so i made it possible to grow them real fast.
	...
	supplementary_reagents = list(
		...
		/datum/reagent/medicine/painkiller/morphine = 4, //morphine is a vital nutrient for space bears, but it is better as a supplemental for gameplay reasons. // NON-MODULE CHANGE
		/datum/reagent/consumable/nutriment/vitamin = 3)
...
/datum/micro_organism/cell_line/slime
	...
	suppressive_reagents = list(
		...
		/datum/reagent/medicine/painkiller/morphine = -2, // NON-MODULE CHANGE
		/datum/reagent/consumable/ice = -2) //Brrr!

	virus_suspectibility = 0
	resulting_atom = /mob/living/simple_animal/slime // Non-module change
