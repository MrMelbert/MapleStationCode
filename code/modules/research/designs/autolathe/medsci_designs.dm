...
/datum/design/medical_scissors
	...
	build_path = /obj/item/razor/scissors/medical
	category = list(
		RND_CATEGORY_INITIAL,
		RND_CATEGORY_TOOLS + RND_SUBCATEGORY_TOOLS_MEDICAL,
	)
