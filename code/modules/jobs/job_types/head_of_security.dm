/datum/job/head_of_security
	...
	description = "Uphold Space Law, coordinate security personnel, prevent corruption, \
		protect every department. Be the only sane person on the station (hopefully)."
