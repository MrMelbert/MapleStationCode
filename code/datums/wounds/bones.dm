...
/datum/wound/blunt/bone/handle_process(seconds_per_tick, times_fired)
	...
	if(!is_bone_limb && SPT_PROB(severity * 1.5, seconds_per_tick))
		victim.damage_random_bodypart(rand(1, severity * 2), wound_bonus = CANT_WOUND)
...
/datum/wound/blunt/bone/critical/apply_wound(obj/item/bodypart/L, silent = FALSE, datum/wound/old_wound = null, smited = FALSE, attack_direction = null, wound_source = "Unknown", replacing = FALSE, injury_roll = 0)
