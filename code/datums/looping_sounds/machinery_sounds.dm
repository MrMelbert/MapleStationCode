...
/datum/looping_sound/clock
	mid_sounds = list('sound/ambience/ticking_clock.ogg')
	mid_length = 40
	volume = 50
	ignore_walls = FALSE
...
/datum/looping_sound/soup
	mid_sounds = list(
		'sound/effects/soup_boil1.ogg',
		'sound/effects/soup_boil2.ogg',
		'sound/effects/soup_boil3.ogg',
		'sound/effects/soup_boil4.ogg',
		'sound/effects/soup_boil5.ogg',
	)
