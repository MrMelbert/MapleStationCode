...
/datum/quirk/prosthetic_limb/add_unique()
	...
	human_holder.del_and_replace_bodypart(prosthetic, TRUE) // NON-MODULE CHANGE
...
/datum/quirk/item_quirk/junkie
	...
	var/drug_list = list(/datum/reagent/drug/blastoff, /datum/reagent/drug/krokodil, /datum/reagent/medicine/painkiller/morphine, /datum/reagent/drug/happiness, /datum/reagent/drug/methamphetamine) //List of possible IDs // NON-MODULE CHANGE
