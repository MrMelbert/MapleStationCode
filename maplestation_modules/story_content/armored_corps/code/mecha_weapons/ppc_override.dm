/obj/item/mecha_parts/mecha_equipment/weapon/energy/ppc
	...
	Possibly the very first technology developped by the Armored Corps after it's reform from the old Armored Division days. Surprisingly, it's still a prototype."
...
/obj/item/mecha_parts/mecha_equipment/weapon/energy/ppc/hellstar //admin-only
	...
	Pretty much only available to the Scarlet Kitsun Unit, which guards the design to be used by themselves alone."
