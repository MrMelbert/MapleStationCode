/obj/item/clothing/neck/annatto_pendant
	...
	icon = 'maplestation_modules/story_content/__crit_equipment/icons/greenleaf_amulet.dmi'
	icon_state = "greenleaf_amulet"
	worn_icon = 'maplestation_modules/story_content/__crit_equipment/icons/greenleaf_amulet_worn.dmi'
