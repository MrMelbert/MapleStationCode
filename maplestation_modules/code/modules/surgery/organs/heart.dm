...
/obj/item/organ/internal/heart/werewolf/on_mob_insert(mob/living/carbon/heart_owner)
	. = ..()
	// Gives rage to the heart owner.
	var/datum/action/cooldown/spell/werewolf_rage/rage = new(heart_owner)
	rage.Grant(heart_owner)

/obj/item/organ/internal/heart/werewolf/on_mob_remove(mob/living/carbon/heart_owner, special = FALSE)
	. = ..()
