...
/datum/loadout_item/under/insert_path_into_outfit(datum/outfit/outfit, list/item_details, mob/living/carbon/human/equipper, visuals_only, job_equipping_step)
...
/datum/loadout_item/under/jumpsuit/random
	...
	loadout_flags = LOADOUT_FLAG_BLOCK_GREYSCALING
	item_path = /obj/item/clothing/under/color/random

/datum/loadout_item/under/jumpsuit/random/on_equip_item(obj/item/equipped_item, list/item_details, mob/living/carbon/human/equipper, datum/outfit/outfit, visuals_only)
