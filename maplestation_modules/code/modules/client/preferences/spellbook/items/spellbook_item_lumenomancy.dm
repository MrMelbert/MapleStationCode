...
/* Customization to allow lesser flare commented out because too confusing and would rather have normal flare in game for now. Along with the has_params var.
