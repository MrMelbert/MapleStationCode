...
export const file_labels = {
	...
	Sprites: {
	  filepaths: ["icons/", "maplestation_modules/icons/"],
	  file_extensions: [".dmi"],
	  add_only: true,
	},
	Sound: {
	  filepaths: ["sound/", "maplestation_modules/sounds/"],
	  file_extensions: [".ogg"],
	  add_only: true,
	},
	UI: {
	...
	"Kilo Station": {
	  filepaths: ['_maps/map_files/KiloStation/KiloStation.dmm'],
	  add_only: true,
	},
	"Lima Station": {
	  filepaths: ['_maps/map_files/LimaStation/LimaStation.dmm'],
	  add_only: true,
	},
	"Pubby Station": {
	  filepaths: ['_maps/map_files/PubbyStation/PubbyStation.dmm'],
	  add_only: true,
	},
	...
	"Story Content": {
	  filepaths: ['maplestation_modules/story_content/'],
	  add_only: true,
	},
  };
