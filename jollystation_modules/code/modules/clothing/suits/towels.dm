...
/obj/item/towel
	...
	icon_state = "towel"
	worn_icon = 'jollystation_modules/icons/mob/clothing/under/towel.dmi'
	worn_icon_state = "towel_worn"
	lefthand_file = 'jollystation_modules/icons/mob/inhands/towel_inhand_lefthand.dmi'
	righthand_file = 'jollystation_modules/icons/mob/inhands/towel_inhand_righthand.dmi'
