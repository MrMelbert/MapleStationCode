          ...
          buttons={
            <>
              ...
              <Button
                ...
                color="red"
                content={target ? 'Checking for Death' : 'Checking for Crit'} // Maple TODO: this is a really weird way to check this and it conflicts with the changed health thresholds, since it expects crit to be 0
                onClick={() => act('target')}
              />
            </>
          }
